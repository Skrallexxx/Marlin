...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 50*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// #define LCD_BACKLIGHT_TIMEOUT_MINS 10  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -14
 ...
 */
   ...
   */
  // #define DISPLAY_SLEEP_MINUTES 10  // (minutes) Timeout before turning off the screen. Set with M255 S.
